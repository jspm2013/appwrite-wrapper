 ...
 */
export function isApwError(error) {
    return (error instanceof AppwriteException && // Check if the error is an instance of AppwriteException
 ...
 */
export const apwExcWrapper = (promise) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
export const handleApwError = (error, locale = "en") => {
    "use server"; // Marks this function as server-only
    var _a;
