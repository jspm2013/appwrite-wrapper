...
const attributeHandlers = {
    string: async (dbId, collId, attr, encrypt = false) => {
    ...
    integer: async (dbId, collId, attr) => {
    ...
    boolean: async (dbId, collId, attr) => {
    ...
    datetime: async (dbId, collId, attr) => {
    ...
    relationship: async (dbId, collId, attr) => {
